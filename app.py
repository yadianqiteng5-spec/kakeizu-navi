...
from core.ui_assets import (
    load_page_icon, hide_streamlit_ui, inject_pwa_assets, inject_seo_meta,
)
...
# Streamlit標準UI（Fork/GitHubバッジ等）を非表示 → PWA → SEOメタ を注入
hide_streamlit_ui()
inject_pwa_assets()
...
# ── ヘッダー ───────────────────────────────────────────────────────────────
st.title("🌳 家系図Navi｜相続・事業承継サポート")
st.markdown(
    "#### 〜 家族構成から「相続」と「事業承継」を見える化するシミュレーター 〜"
)
st.markdown(
    "**家族構成を入力するだけ**で、**法定相続分・遺留分・相続税の概算・事業承継リスク**を自動で診断します。"
)
st.caption(
    "※「家系図Navi」は **相続・事業承継の事前検討をサポートするツール** です。"
    "ご先祖やルーツを調べる家系調査・系譜作成のアプリではありません。"
)
...
st.markdown(
    ...
    <div style="font-weight:600;color:#27AE60;margin-bottom:6px;">📚 相続・事業承継ガイド（68記事+早見表5本+用語集40語 公開中）</div>
    <div style="font-size:13px;line-height:1.8;">
    <a href="https://kakeizu.appsnavi.net/inheritance-procedure/" target="_blank" rel="noopener" style="color:#2980B9;text-decoration:none;margin:0 6px;">相続手続きの全体像</a>・
    <a href="https://kakeizu.appsnavi.net/inheritance-tax/" target="_blank" rel="noopener" style="color:#2980B9;text-decoration:none;margin:0 6px;">相続税の基礎控除</a>・
    <a href="https://kakeizu.appsnavi.net/will-template/" target="_blank" rel="noopener" style="color:#2980B9;text-decoration:none;margin:0 6px;">自筆証書遺言の書き方</a>・
    <a href="https://kakeizu.appsnavi.net/business-succession/" target="_blank" rel="noopener" style="color:#2980B9;text-decoration:none;margin:0 6px;">事業承継のリスク</a>・
    <a href="https://kakeizu.appsnavi.net/post-death-timeline/" target="_blank" rel="noopener" style="color:#2980B9;text-decoration:none;margin:0 6px;">死後手続きタイムライン</a>・
    <a href="https://kakeizu.appsnavi.net/family-trust/" target="_blank" rel="noopener" style="color:#2980B9;text-decoration:none;margin:0 6px;">家族信託</a>・
    <a href="https://kakeizu.appsnavi.net/endlife-checklist/" target="_blank" rel="noopener" style="color:#2980B9;text-decoration:none;margin:0 6px;">終活チェックリスト</a>
    <br>
    <a href="https://kakeizu.appsnavi.net/guides/" target="_blank" rel="noopener" style="color:#27AE60;font-weight:600;text-decoration:none;margin:0 8px;">▶ 全68記事を見る</a>
    <a href="https://kakeizu.appsnavi.net/table-inheritance-tax/" target="_blank" rel="noopener" style="color:#27AE60;font-weight:600;text-decoration:none;margin:0 8px;">📊 早見表</a>
    <a href="https://kakeizu.appsnavi.net/cases/" target="_blank" rel="noopener" style="color:#27AE60;font-weight:600;text-decoration:none;margin:0 8px;">📁 ケース集</a>
    <a href="https://kakeizu.appsnavi.net/glossary/" target="_blank" rel="noopener" style="color:#27AE60;font-weight:600;text-decoration:none;margin:0 8px;">📖 用語集（40語）</a>
    <a href="https://kakeizu.appsnavi.net/about/" target="_blank" rel="noopener" style="color:#27AE60;font-weight:600;text-decoration:none;margin:0 8px;">ℹ️ About</a>
    <br>
    🔗 姉妹サイト：
